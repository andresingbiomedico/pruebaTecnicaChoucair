...
@tag1
  Scenario: Visit to Utest.com, register an user and verify user registration
    ...
    |andres       |quintero |pipe6@hotmail.com   |August|13  |1995 |WA5rb6kSMtitD76AdLB^|WA5rb6kSMtitD76AdLB^      |El Carmen de Viboral|054030|Colombia |Apple|iPhone 8|iOS 15.0.1  |
